const RecurCards = () => {
    return (
        <div className="grid grid-cols-3 gap-4 place content-evenly m-5">
            <div className="bg-teal-100 rounded-2xl p-14">
                <div className="p-3 font-bold text-2xl text-center">For Recruiters</div>
                <div className="p-4 text-4xl font-bold text-justify">Be your own boss, join JobZoom.com Today</div>
            ...
            <div className="bg-neutral-100 rounded-2xl p-14">
                ...
                <span className="bg-cyan-700 font-bold text-lg rounded-md m-3 p-3 text-white text-center  flex justify-center hover:scale-105 shadow-2xl hover:-translate-y-1 transform transition duration-300 ease-in-out">
